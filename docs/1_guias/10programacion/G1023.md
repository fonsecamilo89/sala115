# Guía 1023: Desarrollo de algoritmos (P2)
...
1. Lea los siguientes conceptos relacionados con diagramas de flujo.
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image01.png
    :width: 250
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image04.png
    :width: 150
    Conexión
    ```
:::
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image05.png
    :width: 150
    Dirección
    ```
:::
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image06.png
    :width: 150
    Entrada
    ```
:::
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image07.png
    :width: 150
    Documento
    ```
:::
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image08.png
    :width: 120
    Base de datos
    ```
:::
...
1. Lea los siguientes conceptos relacionados con la temática de algoritmos.

---
### ¿Qué es una algoritmo?

:::{admonition} Los algoritmos son útiles para resolver problemas
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image09.png
    :width: 400
    ```
:::
...
---
## A04: Orientaciones al extranjero (+1,0)
...
---
## A06: ¿Qué son los algoritmos? (+0,2)
{bdg-info}`Estructuración`

1. Escriba las siguientes frases en su cuaderno e indique si es **falso** o **verdadero** e indique el por qué.
    - Un algoritmo está compuesto por elementos informáticos que componen una secuencia organizacional únicamente ___.
    - Un algoritmo son un conjunto de instrucciones que le dicen a una computadora o un ser humano como realizar una tarea específica, dichas instrucciones pueden estar escritas en código o lenguaje natural. ___.
    - Un algoritmo se define como cuadros de funcionamiento infinitos que permiten y tienen como propósito reducir la información. ___.

---
## A07: Tipos del algoritmos (+0,2)
{bdg-info}`Estructuración`
...
---
## A08: Clasificación de algoritmos (+0,2)
{bdg-info}`Estructuración`
...
---
## A09: Metodología para desarrollar un algoritmo (+0,2)
{bdg-info}`Estructuración`
