...
- **DESEMPEÑO**: Comprende y aplica los fundamentos de Python: identifica su historia y características, utiliza correctamente la consola interactiva para ejecutar comandos y consultar documentación (help, topics, copyright, credits, license), y resuelve ejercicios prácticos demostrando autonomía y precisión en la interpretación de la información técnica.
```
...
```{tab-item} Recursos (2)
- **Plan de refuerzo 03.pdf** [{bdg-primary}`Descargar`](./recursos/G1023/archivos/planRefuerzo03.pdf)
...
:shadow: lg
:img-top: ./recursos/G1023/image01.png
:width: 25%
...
:::{admonition} ¿Qué es un lenguaje de programación?
:class: tip
...
:shadow: lg
:width: 50%
:img-background: ./recursos/G1023/logo-tiobe.svg
```
...
:::{admonition} ¿Cuales son las fuentes del índice TIOBE?
:class: tip
...
:::{list-table}
+ - ```{figure} ./recursos/G1023/image02.png
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image03.png
...
:::{admonition} Desarrollo de software
...
- Automatización de tareas de escritorio para emular clics del mouse, entradas por teclado para tareas repetitivas, envío automático de correos electrónicos y recolección automática de datos de sitios web. (Herramienta **schedule**)
    ...
    ```{card} Schedule
    :shadow: lg
    :img-bottom: ./recursos/G1023/image04.svg
...
- Pruebas de depuración en funciones específicas de ejecución para encontrar comportamientos no deseados en la aplicación. (herramienta PyTest)
    ...
    ```{card} Pytest
    :shadow: lg
    :img-bottom: ./recursos/G1023/image05.png
...
:img-bottom: ./recursos/G1023/image09.png
:img-alt: Enlace PyGAME
```
```{grid-item-card} PANDA 3D
:link: https://www.panda3d.org/
:img-bottom: ./recursos/G1023/image10.png
:img-alt: Enlace a PANDA 3D
```
:::
:::

:::{admonition} Inteligencia artificial
...
- Con la herramienta **TensorFlow** se pueden crear modelos de aprendizajes profundos. Los programadores pueden construir y entrenar redes neuronales complejas para aplicaciones como reconocimiento de voz o visión por computadora.
    ...
    :::{card} TensorFlow
    :shadow: lg
    :img-bottom: ./recursos/G1023/image11.svg
...
- Con **PANDAS** se trabajan estructuras, limpieza, transformación y análisis de datos. Es ideal para manejar grandes conjuntos de datos de forma eficiente.
    ...
    :img-bottom: ./recursos/G1023/image12.png
...
- **NumPy** se usa para ejecutar cálculos numéricos. Soporta arreglos multidimensionales y funciones matemáticas de alto rendimiento. También se pueden trabajar sobre aplicaciones estadísticas que requieran analizar altos volúmenes de información.
    ...
    :img-bottom: ./recursos/G1023/image13.svg
...
- **Matplotlib** es usado para visualización de datos con gráficos estadísticos estáticos, animados o interactivos.
    ...
    :img-bottom: ./recursos/G1023/image14.svg
...
:::{list-table}
* - ```{figure} ./recursos/G1023/image15.png
    :width: 700
    Consola interactiva PYTHON
    ```
:::
...
- Versión de Python: `v3.13.1:06714517797`
- Fecha de compilación: `Dec 3 2024, 14:00:22`
- Herramienta de compilación de la consola PYTHON: `Clang 15.0.0`. 
...
2. Cree un **diagrama de flujo** que explique las **principales características** de PYTHON. **No es necesario escribir la descripción de la característica**. Tenga en cuenta lo siguiente:
...
3. Responda si es **falso**, **verdadero** y **por qué**:
...
5. Con la gráfica: **Evolución del uso de PYTHON desde el año 2002**, desarrolle la siguiente tabla en su cuaderno (identifique a diciembre del año):
...
6. Con la tabla: **Ranking de los lenguajes de programación más usados en Diciembre de 2024 y 2025**, cree un gráfica así:

    :::{list-table}
    * - ```{figure} ./recursos/G1023/image16.png
        :width: 240
        EJEMPLO
        ```
    :::
...
7. Cree un **mapa conceptual** de herramientas usadas PYTHON. El mapa conceptual debe tener 3 niveles:
    - 1 NIVEL: Título Aplicaciones de PYTHON
    - 2 NIVEL: 5 aplicaciones concretas
    - 3 NIVEL: Herramientas por cada aplicación concreta.

8. En su cuaderno, COMPLETE la siguiente sopa de letras con 16 términos relacionados con el lenguaje de programación **PYTHON**. En la medida que encuentre un término, realice su descripción.

    :::{list-table} 
    * - ```{figure} ./recursos/G1023/image17.png
        :width: 550
        Términos PYTHON
        ```
    :::
...
---
## A02: Consola interactiva Python (15%)
{bdg-warning}`Actividad práctica`
...
---
## A03: Ayuda en la consola interactiva (15%)
{bdg-warning}`Actividad práctica`
...
**INSTRUCCIONES** ; Ejecute los comandos relacionados con la consola interactiva de PYTHON.
```

:::{admonition} Posibles ejercicios
