...
- **DESEMPEÑO**: Desarrolla algoritmos coherentes para la solución de problemas propuestos, siguiendo con precisión las fases de análisis y diseño. Logra representar procesos secuenciales mediante diagramas de flujo funcionales y es capaz de transformar eficazmente situaciones de la vida cotidiana en secuencias lógicas estructuradas.
```
...
```{tab-item} Recursos (1)
- **Plan de refuerzo 02.pdf** [{bdg-primary}`Descargar`](./recursos/G1022/archivos/planRefuerzo02.pdf)
```
:::
...
:::{admonition} Operación

```{list-table}
* - ```{figure} ./recursos/G1022/image01.png
    :width: 250
...
:::{admonition} Límites de proceso

```{list-table}
* - ```{figure} ./recursos/G1022/image02.png
    :width: 250
    Inicio - Fin
    ```
```
...
:::{admonition} Punto de decisión

```{list-table}
* - ```{figure} ./recursos/G1022/image03.png
    :width: 150
    Condicional
    ```
````
...
:::{admonition} Conector
```{list-table}
* - ```{figure} ./recursos/G1022/image04.png
    :width: 150
    Conexión
    ```
```
...
:::{admonition} Dirección de flujo

```{list-table}
* - ```{figure} ./recursos/G1022/image05.png
    :width: 150
    Dirección
    ```
```
...
:::{admonition} Entrada manual
```{list-table}
* - ```{figure} ./recursos/G1022/image06.png
    :width: 150
    Entrada
    ```
```
...
:::{admonition} Documento

```{list-table}
* - ```{figure} ./recursos/G1022/image07.png
    :width: 150
    Documento
    ```
```
...
:::{admonition} Base de datos

```{list-table}
* - ```{figure} ./recursos/G1022/image08.png
    :width: 120
    Base de datos
    ```
```
...
:::{admonition} FASE 01:  Análisis de requisitos (objetivo y condiciones)
...
:::{admonition} FASE 02: Diseño del algoritmo (diagrama de flujo)
...
:::{admonition} FASE 03: Construcción del algoritmo (código fuente)
...
:::{admonition} EJERCICIO: Algoritmo para ir al colegio
:class: warning
...
:class: tip
```{list-table}
* - ```{figure} ./recursos/G1022/image09.png
    :width: 400
    ```
```
:::
...
2. En su cuaderno relacione con líneas los siguientes cuadros según corresponda su significado:

    :::{list-table}
    * - ```{figure} ./recursos/G1022/image10.png
        :width: 500
        Cuadro comparativo (Tipos de algoritmos)
        ```
    :::

3. Escriba la siguiente tabla en su cuaderno y clasifique los algoritmos según corresponda:
    ...
    <br/>PASO 02: Inserte hojas tamaño carta
    <br/>PASO 03: Cierre la bandeja de entrada||
    BIOS||
    **CANVA**||
    LibreOffice Writer||
...
4. En su cuaderno describa las 3 fases para desarrollar un algoritmo.

5. Responda la siguiente pregunta en su cuaderno:
    - ¿Que diferencia hay entre desarrollar un algoritmo, diseñar un algoritmo y construir un algoritmo?

6. Consulte en INTERNET que hace un arquitecto de software y luego en su cuaderno responda:
...
8. En su cuaderno escriba una serie de **instrucciones** (seguras, claras y eficientes) para que un estudiante vaya al colegio desde que se despierta hasta que llega al aula de clase.

9. En su cuaderno describa cada una de las figuras de un **diagrama de flujo** y dibuje sus símbolos.
...
1. Lea el siguiente caso:
    ...
    :::{list-table}
    * - ```{figure} ./recursos/G1022/image11.png
        :width: 650
        Mapa Puerto Boyacá
        ```
    :::
...
2. En su **cuaderno**, cree un **diagrama de flujo** con 15 instrucciones que le permitan al extranjero llegar a cada una de las iglesias. Tenga en cuenta lo siguiente:
    ...
    :::{list-table}
    * - ```{figure} ./recursos/G1022/image12.png
        :width: 700
...
3. En su cuaderno, adapte el algoritmo de la actividad anterior, de tal forma que contenga 3 condicionales.
    ...
    :::{list-table}
    * - ```{figure} ./recursos/G1022/image13.png
        :width: 700
...
[^2]: Trejos Buriticá, O. I. (2017). Lógica de programación. Ediciones de la U.