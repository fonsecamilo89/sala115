...
- **Plan de refuerzo 02.pdf** [{bdg-primary}`Descargar`](./recursos/G822/archivos/planRefuerzo02.pdf)
...
```{csv-table} Tabla de estudiantes
:class: black
...
4. En su cuaderno complete la siguiente tabla:
...
5. DIBUJE la siguiente gráfica en su cuaderno y en cada anillo ubique un elemento de la **Jerarquía de datos**:

:::{list-table}
* - ```{figure} ./recursos/G822/image01.png
    :width: 400
    **Anillo** Jerarquía de datos
    ```
:::

6. DIBUJE el siguiente gráfico en su cuaderno:

    :::{list-table}
    * - ```{figure} ./recursos/G822/image02.png
        :width: 550
...
* - ```{csv-table}
    :header-rows: 1
    ID, Nombre, Apellido, Edad, Curso de Ingreso, Año de Ingreso, Año de Egreso, Software más usado, Hardware más usado
    00,,,,,,,,
    01,,,,,,,,
    02,,,,,,,,
    03,,,,,,,,
...
:::{list-table} Tabla Cuentas Institucionales Estudiantes
* - ```{csv-table}
    :header-rows: 1
...
3. En una hoja de su cuaderno (de forma horizontal), dibuje la siguiente base de datos:

    :::{list-table}
    * - ```{figure} ./recursos/G822/image03.png
        :width: 620
        EJEMPLO Base de datos
        ```
    :::

4. Acorde a la **base de datos**, en su cuaderno responda las siguientes preguntas:
...
5. En la base de datos (dibujada en su cuaderno), identifique las **tablas**, **registros** y los **datos**.

6. Con sus palabras, en su cuaderno explique cómo esta compuesta la **Tabla facturas**.

7. En su cuaderno, cree un nuevo registro para la **Tabla clientes**.

8. En su cuaderno, cree un nuevo registro para la **Tabla productos**.

9. Con los nuevos registros **Tabla clientes** y **Tabla productos**, ahora cree una nueva *base de datos* compuesta por la **Tabla facturas** y la **Tabla elementos en línea**.
