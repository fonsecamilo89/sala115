# Guía 822: Jerarquía de datos (P2)
...
---
## A01: Información y Jerarquía de datos (+0,1)
{bdg-info}`Estructuración`
...
:::{admonition} Concepto de información
...
:::{admonition} Concepto de Jerarquía de datos
...
---
## A04: Construcción de tablas (+0,1)
{bdg-warning}`Actividad práctica`
...
:::{csv-table} Tabla Cuentas Institucionales Estudiantes
:header-rows: 1
...
4. Con sus palabras, en su cuaderno explique cómo esta compuesta la **Tabla facturas**.
