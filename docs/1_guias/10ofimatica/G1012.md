...
4. Analice los siguientes casos y en su cuaderno explique si el software es libre o no. Identifique si cumple las **4 libertades esenciales** y explique el por qué:
...
7. Desarrolle los siguientes cálculos en su cuaderno:
...
8. Lea las **características** del software libre, software propietario y el software pirata. Luego complete el siguiente cuadro en su cuaderno:
...
11. En una hoja de cuaderno, complete la siguiente tabla:
...
12. RESPONDA en su cuaderno las siguientes preguntas:

    - ¿Que es LibreOffice?
    - ¿Qué significa **ODF**?

13. COPIE las siguientes frases en su cuaderno e INDIQUE si es **falso**, **verdadero** y por qué:
...
14. En su cuaderno complete la siguiente tabla:
...
15. En su cuaderno, diligencie la siguiente tabla colocando el nombre de la herramienta contraparte de Microsoft Office frente a LibreOffice. Explique también la función que tiene dichas herramientas. (**Si no existe contraparte, escribir N/A**).
...
16. ANALICE los siguientes casos, eliga la mejor herramienta de LibreOffice para cada caso y explique el por qué:
...
17. Para cada una de las ventajas de LibreOffice, en su cuaderno responda la siguiente pregunta:

    - ¿Cómo se beneficiaría la comunidad académica si se implementara LibreOffice en la Institución Educativa?

---
## A03: Carta al propietario (+4,0)
{bdg-danger}`Transferencia`
...
**TIEMPO** ; 59 minutos
**PREGUNTAS** ; 0
**OBJETIVO** ; Aplicar sus conocimientos en software libre para orientar al propietario de un negocio.
**ACTIVIDAD** ; Situación carta al propietario.
```
