...
---
## A04: Importancia del software libre (+0,6)
{bdg-warning}`Actividad práctica`
...
3. A partir de los **ejemplos de software libre**, en su cuaderno diligencie el siguiente crucigrama:
...
4. En su cuaderno, REALICE una **descripción** de cada uno de los ejemplos de software libre, encontrados en el anterior crucigrama.

5. Desarrolle los siguientes cálculos en su cuaderno:
...
---
## A05: Relación entre software libre, software propietario y software pirata (+0,2)
{bdg-warning}`Actividad práctica`
...
---
## A06: El riesgo del software pirata (+0,1)
{bdg-warning}`Actividad práctica`
...
3. En su cuaderno complete la siguiente tabla:
...
4. En su cuaderno, diligencie la siguiente tabla colocando el nombre de la herramienta contraparte de Microsoft Office frente a LibreOffice. Explique también la función que tiene dichas herramientas. (**Si no existe contraparte, escribir N/A**).
...
5. ANALICE los siguientes casos, eliga la mejor herramienta de LibreOffice para cada caso y explique el por qué:
...
6. Para cada una de las ventajas de LibreOffice, en su cuaderno responda la siguiente pregunta:

    - ¿Cómo se beneficiaría la comunidad académica si se implementara en la Institución Educativa?

---
## A09: Carta al propietario (+3,0)
{bdg-danger}`Transferencia`
