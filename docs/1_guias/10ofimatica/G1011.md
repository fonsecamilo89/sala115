# Guía 1011: Ofimática y Software Libre (P1)
...
---
## A01: Ofimática y software libre (5%)
{bdg-info}`Estructuración`
...
:::{admonition} Concepto de ofimática
...
:::{admonition} Clasificación de software
...
:::{admonition} 4 Libertades del software libre
...
:::{admonition} Sistema Operativo **GNU-LINUX** ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image01.png
    :width: 300
    Logo GNU/Linux
    ```
```
...
:::{admonition} Navegador web **Mozilla FIREFOX** ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image02.png
       :width: 360
...
:::{admonition} Editor de imágenes **GIMP** ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image03.png
       :width: 300
       Logo **Gimp**
    ```
```
...
:::{admonition} Editor de gráficos vectoriales **INKSCAPE** ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image04.png
       :width: 360
       Logo **INKSCAPE**
    ```
```
...
:::{admonition} Reproductor multimedia **VLC** ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image05.png
    :width: 400
    Logo **VLC**
    ```
```
...
:::{admonition} Suite de creación 3D BLENDER ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image06.png
    :width: 360
    Logo **BLENDER**
    ```
```
...
:::{admonition} Edición de sonido Audacity ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image07.png
    :width: 360
    Logo **Audacity**
    ```
```
...
:::{admonition} Suite ofimática LibreOffice ($0)

```{list-table}
* - ```{figure} ./recursos/G1011/image08.png
       :width: 360
       **LibreOffice**
    ```
```
...
:::{admonition} Sistema operativo Microsoft Windows ($769,999)

```{list-table}
* - ```{figure} ./recursos/G1011/image09.png
    :width: 300
...
:::{admonition} Microsoft Office (suite ofimática) ($459,999/año)

```{list-table}
* - ```{figure} ./recursos/G1011/image10.png
    :width: 300
    Microsoft **Office**
    ```
```
...
:::{admonition} Google Workspace (Plan gratuito $0)
```{list-table}
* - ```{figure} ./recursos/G1011/image22.png
    :width: 700
...
:::{admonition} Adobe Photoshop (editor de imágenes) ($48,971/mes)

```{list-table}
* - ```{figure} ./recursos/G1011/image11.png
    :width: 360
...
:::{admonition} AutoCAD (software de diseño) ($2,201,999/año)

```{list-table}
* - ```{figure} ./recursos/G1011/image12.png
    :width: 360
...
:::{list-table}
* - ```{figure} ./recursos/G1011/image13.png
    :width: 300
    Suite LibreOffice
    ```
:::
...
País | Descripción
-|-
**FRANCIA** | El equipo de trabajo inter-ministerial para el software libre del Gobierno francés, ejecuta LibreOffice en aproximadamente 500,000 equipos. El software se emplea en varios ministerios, incluidos los de Energía, Defensa, Agricultura y Educación.
...
**ALEMANIA** | En Alemania, la ciudad de Munich ha migrado más de 15,000 equipos a LibreOffice. Esto forma parte de una transición más ambiciosa hacia el software libre y de código abierto (FOSS), que incluye el sistema operativo GNU/Linux.
**TAIWAN** | El Ministerio de Finanzas de Taiwan ha instalado LibreOffice en más de 24,000 PC. Con esta iniciativa, el formato estandarizado OpenDocument está convirtiéndose en la norma para el intercambio de datos entre los diversos departamentos.
...
:::{admonition} LibreOffice Writer (procesador de textos)

```{list-table}
* - ```{figure} ./recursos/G1011/image14.png
    :width: 270
    LibreOffice Writer
    ```
```
...
:::{admonition} LibreOffice Calc (hoja de cálculo)

```{list-table}
* - ```{figure} ./recursos/G1011/image15.png
    :width: 190
    LibreOffice Calc
    ```
```
...
:::{admonition} LibreOffice Impress (presentaciones)

```{list-table}
* - ```{figure} ./recursos/G1011/image16.png
    :width: 270
    LibreOffice Impress
    ```
```
...
:::{admonition} LibreOffice Draw (Dibujo vectorial)

```{list-table}
* - ```{figure} ./recursos/G1011/image17.png
    :width: 230
    LibreOffice Draw
    ```
```
...
:::{admonition} LibreOffice Math (Editor de fórmulas)

```{list-table}
* - ```{figure} ./recursos/G1011/image18.png
    :width: 240
    LibreOffice Math
    ```
```
...
2. En su cuaderno, escriba una lista de 10 ejemplos de software que usted conozca (de smartphone, de computadores, aplicativo web, etc.) NO OLVIDE HACER UNA BREVE DESCRIPCIÓN POR CADA UNO.

3. Para cada uno de los ejemplos escritos anteriormente, identifique si es **software de sistema**, **software de aplicación**, **software libre**, **software propietario** o **software pirata** y explique el por qué.

4. En su cuaderno responda las siguientes preguntas:
...
5. A partir de los **ejemplos de software libre**, en su cuaderno diligencie el siguiente crucigrama:

    :::{list-table}
    * - ```{figure} ./recursos/G1011/image20.png
        :width: 500
...
6. En su cuaderno, realice una **descripción** de cada uno de los **ejemplos de software libre**, encontrados en el anterior crucigrama. 

7. Lea las **características** del software libre, software propietario y el software pirata. Luego complete el siguiente cuadro en su cuaderno:
...
10. responda en su cuaderno las siguientes preguntas:

    - ¿Que es LibreOffice?
    - ¿Qué significa **ODF**?

11. copie las siguientes frases en su cuaderno e INDIQUE si es **falso**, **verdadero** y por qué:
...
12. En su cuaderno complete la siguiente tabla:
...
13. En su cuaderno, diligencie la siguiente tabla colocando el nombre de la herramienta contraparte de Microsoft Office frente a LibreOffice. Explique también la función que tiene dichas herramientas. (**Si no existe contraparte, escribir N/A**).
...
---
## A03: Análisis de casos (20%)
{bdg-warning}`Actividad práctica`

1. En su cuaderno analice los siguientes casos e indique a que **área de trabajo de la ofimática** corresponde y explique por qué.
...
3. Para cada uno de los casos, seleccione el servicio que más convenga. No olvide explicar el por qué. Los servicios son:
...
4. Desarrolle los siguientes cálculos en su cuaderno (EVIDENCIE EL PROCEDIMIENTO):
...
5. En una hoja de cuaderno, responda: ¿Qué medidas tomaría usted para solucionar la siguiente situación?:
...
6. ANALICE los siguientes casos, elegir la mejor herramienta de LibreOffice para cada caso y explique el por qué:
...
**TIEMPO** ; 59 minutos
**PREGUNTAS** ; 0
**OBJETIVO** ; Aplicar sus conocimientos en ofimática y software libre para orientar al propietario de un negocio.
**INSTRUCCIONES** ; Actividad individual. No se permite el uso ni de computadores ni de dispositivos móviles. El estudiante debe trabajar con los apuntes de su cuaderno.
```
...
2. En una **hoja de cuaderno**, REDACTE una **carta** aconsejando a su jefe sobre el uso del **software libre** en el negocio. Tenga en cuenta lo siguiente:
    ...
    :::{list-table}
    * - ```{figure} ./recursos/G1011/image21.png
        :width: 400
...
[^18]: Superior, E. F. P. (2023, August 31). ¿Qué es la ofimática y para qué sirve?: herramientas. Esic.edu; ESIC. https://www.esic.edu/business/que-es-la-ofimatica-para-que-sirve-c