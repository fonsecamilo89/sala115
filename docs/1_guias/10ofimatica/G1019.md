...
**Microsoft Office** es un conjunto de aplicaciones de software de productividad creado por **Microsoft**&reg;. Es una herramienta muy popular y ampliamente utilizada en todo el mundo para una variedad de tareas relacionadas con la creación, edición y gestión de documentos, hojas de cálculo, presentaciones y más.
