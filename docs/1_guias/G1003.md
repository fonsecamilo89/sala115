...
```{tab-item} Recursos (2)
- [**LECTURA:** Mantenimiento](../2_lecturas/L1003-01.md)
- [**LECTURA:** Electrónica y electricidad](../2_lecturas/L1003-02.md)
```
:::
...
---
## AXX-1: Preguntas de indagación (+0,5)
{bdg-info}`Estructuración`

1. En su cuaderno, responda las siguientes preguntas:

---
## AXX: Análisis de reflexión (+4,0)
