...
- **Temática**: Anteproyecto de grado.
...
```{tab-item} Recursos (1)
- **Plan de refuerzo 04.pdf** [{bdg-primary}`Descargar`](./recursos/G1004/archivos/planRefuerzo04.pdf)
```
:::
...
:::{pull-quote}
"El desarrollo de un **proyecto de grado** representa una **oportunidad fundamental** para **aplicar** los **conocimientos adquiridos** durante su formación.

Esta guía tiene como propósito **orientar al estudiante** en formular una propuesta de **proyecto de grado** que de **solución** a una  **necesidad o problema** en nuestra institución".
...
1. Transcriba en su cuaderno la **temática**, el **objetivo de aprendizaje** y el **desempeño** de la presente guía.

2. En una **hoja de cuaderno** escriba con letra grande:

    - EL {**TEMA DE SU PROYECTO DE GRADO**}.
    - LA {**IDEA DE SU PROYECTO DE GRADO**}.
...
1. Realice un resumen de la siguiente información en su cuaderno:
    ...
    - *¿**Qué** se quiere investigar?* (Identificación del trabajo a realizar) (idea de proyecto)
    - *¿**Cómo** se realizará el proyecto?* (Identificación de la tecnología a usar) (tecnología relacionada con su idea de proyecto)
    - *¿**Dónde** se realizará el proyecto?* (Lugar dentro de la Institución Educativa) (aulas, laboratorios, oficinas, cafeteria, etc.)
...
4. Abra el archivo **ANTEPROYECTO.odt**
...
3. Abra el archivo **ANTEPROYECTO.odt**
...
2. Por medio de **búsquedas simples**, consulte mínimo **5 temáticas** relacionadas con el **título de su proyecto de grado**. 
...
4. Por medio de **búsquedas avanzadas**, descargue diferentes archivos en PDF de investigaciones previas relacionadas con el **título de su proyecto de grado**. Los archivos PDF encontrados, guardarlos en su **carpeta de evidencias**.

5. Abra el archivo **ANTEPROYECTO.odt**
    :::{admonition} En el archivo **ANTEPROYECTO.odt**
...
6. Acceda al siguiente enlace: [GESTOR NORMATIVO](https://www1.funcionpublica.gov.co/web/eva/gestor-normativo).
...
7. Abra el archivo **ANTEPROYECTO.odt**
    :::{admonition} En el archivo **ANTEPROYECTO.odt**
...
1. Realice un resumen de la siguiente información en su cuaderno:
    ...
    :::{admonition} CONSTRUCCIÓN DE LOS ASPECTOS METODOLÓGICOS
    :class: tip
    ...
    ```{csv-table} **Cronograma de actividades**
    :delim: ;
    :header-rows: 1
    :stub-columns: 1
    ...
    ```{admonition} Técnicas e instrumentos
    :class: tip
...
2. Abra el archivo **ANTEPROYECTO.odt**
...
3. Guarde los cambios y cierre el software LibreOffice Calc.
...
1. Realice un resumen de la siguiente información en su cuaderno:
    ...
    :::{admonition} CONSTRUCCIÓN DE LAS REFERENCIAS
    :class: tip
    ...
    Para la construcción de las referencias del proyecto, inicialmente se deben tener algún enlace de consulta. Por ejemplo se tiene el siguiente enlace: [https://economipedia.com/definiciones/mantenimiento.html](https://economipedia.com/definiciones/mantenimiento.html)
    
    1. Para referenciar este enlace (cumpliendo las normas APA), se hace uso de la siguiente herramienta en línea: [BIBGURU](https://app.bibguru.com/)
    ...
    * - ```{figure} ./recursos/G1004/image04.png
        ...
        ```
    ```
    2. Es necesario seleccionar el estilo en la opción: **APA - 7th edition**. Posteriormente se debe copiar y pegar el enlace en el cuadro donde dice: **`Paste URL of the website you want to cite`**

    3. Posteriormente aparecerá una ventana donde muestra la referencia y dar clic en {guilabel}`+ Add`
    
    4. Entonces se creará la siguiente referencia:
...
2. Abra el archivo **ANTEPROYECTO.odt**
    ...
    - Use el aplicativo [BIBGURU](https://app.bibguru.com/) para construir sus referencias.
...
1. Al documento: **ANTEPROYECTO.odt** exportar a PDF y agregar una **marca de agua** con el nombre: **ANTEPROYECTO**. El nombre del documento PDF generado es: **ANTEPROYECTO.pdf**. (Para mayor información consulte la actividad [A06: Generación de PDFs](../10ofimatica/G1014.md))

2. Imprimir el archivo **ANTEPROYECTO.pdf**

3. Buscar un [^1] **asesor** de **proyecto de grado** en la institución y solicitar la **firma del mismo**. (Los docentes o cualquier otro funcionario no están obligados a firmar. La solicitud por parte del estudiante debe ser de forma respetuosa cumpliendo las normas del *manual de convivencia*).

4. Entregar el ***documento impreso y firmado*** para correcciones.

5. Un **código de proyecto** (P20XXYY) es asignado al estudiante para la identificación del **proyecto de grado**.

6. El estudiante recibe un **acceso** a una **carpeta compartida en la nube** para que suba:
    - El **documento escaneado** con las correcciones.
    - El archivo **ANTEPROYECTO.odt**

7. El **estudiante** y su **proyecto** son registrados en el [repositorio de proyectos](https://www.jfkennedy.edu.co/estudiantes/proyectos-de-grado/) de la institución educativa.

[^1]: Un asesor es una persona que brinda orientación y asesoramiento a los estudiantes que trabajan en su trabajo de grado. *Yourspanish. (2023, junio 1). Asesores de tesis. Your Spanish Institute. https://www.yourspanishinstitute.com/asesor-de-tesis/*