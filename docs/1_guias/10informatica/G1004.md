...
- **Evidencia de aprendizaje**: Diseño y aplico planes sistemáticos de mantenimiento correctivo en productos tecnológicos analógicos y digitales utilizados en la vida diaria.
```
...
"Al final de la guía encontrará unas preguntas de reflexión para identificar si el tema de **mantenimiento** y **electrónica** le genera interés. Una de estas temáticas podría ser su elección para su proyecto de grado".
...
:::{admonition} Clasificación del **mantenimiento preventivo** 
...
:::{admonition} Clasifición del **mantenimiento correctivo**
...
3. Responda las siguientes preguntas en su cuaderno:
    - ¿Cómo funciona la electricidad?
    - ¿De que forma se transmite la electricidad? 

4. Describa y dibuje en su cuaderno 10 dispositivos electrónicos, luego por cada uno responda:

    - ¿Que tocaría hacer si no existiera dicho dispositivo electrónico?

5. Consulte en INTERNET qué es un **PANEL SOLAR** y luego escríba la información en su cuaderno.

6. Consulte en INTERNET los **precios de compra e instalación de paneles solares** en el municipio. Luego escriba la información consultada en el cuaderno. (También escribir los enlaces a la página web donde encontró la información).

7. Complete la siguiente tabla en su cuaderno:
...
8. En INTERNET, consulte 5 ejemplos de proyectos que se pueden hacer usando **ARDUINO** y descríbalos en su cuaderno (incluya dibujos).

9. En INTERNET, consulte 5 ejemplos de proyectos que se pueden hacer usando una **Rapsberry Pi** y descríbalos en su cuaderno (incluya dibujos).

---
## A03: Análisis y reflexión (+4,0)
{bdg-danger}`Transferencia`
