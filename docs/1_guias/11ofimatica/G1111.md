...
```{tab-item} Recursos (7)
- G1111A07-calificaciones.xls [{bdg-primary}`Descargar`](./recursos/G1111/archivos/G1111A07-calificaciones.xls)
- G1111A08-antiguedad-saldos.ods [{bdg-primary}`Descargar`](./recursos/G1111/archivos/G1111A08-antiguedad-saldos.ods)
- G1111A08-calculo-precios.ods [{bdg-primary}`Descargar`](./recursos/G1111/archivos/G1111A08-calculo-precios.ods)
- G1111A09-animales-raza.ods [{bdg-primary}`Descargar`](./recursos/G1111/archivos/G1111A09-animales-raza.ods)
- G1111A10-frutas.ods [{bdg-primary}`Descargar`](./recursos/G1111/archivos/G1111A10-frutas.ods)
- G1111A10-ventas-ferreteria.ods [{bdg-primary}`Descargar`](./recursos/G1111/archivos/G1111A10-ventas-ferreteria.ods)
...
---
## A04: Interfaz de LibreOffice Calc {kbd}`001` (5%)
{bdg-warning}`Actividad práctica`
...
3. En la interfaz de LibreOffice Calc identifique:
...
4. Cierre el software LibreOffice Calc.

---
## A05: Selección de celdas y rangos {kbd}`018` (5%)
{bdg-warning}`Actividad práctica`
...
7. Realice una captura de pantalla con la figura formada y guarde la imagen en la carpeta de evidencias del periodo actual con el nombre: **G1111A05-seleccionCeldas.png**
...
---
## A07: Gestión de documentos {kbd}`512` (5%)
{bdg-warning}`Actividad práctica`
...
6. Realice una captura de pantalla y guarde la imagen en la carpeta de evidencias del periodo actual. El nombre de la imagen es: **G1111A07-creacionArchivos.png** (En la imagen se deben ver los cuatro documentos creados abiertos y la fecha).
...
9. GUARDE el documento con el nombre: **G1111A07-primerasPracticas.ods** en la carpeta de evidencias del periodo actual.
    
10. MODIFIQUE el contenido del documento.

11. Vuelva a GUARDAR el documento pero esta vez en el menú superior PULSAR **Archivo** > **Guardar como…** y cambie de nombre a: **G1111A07-masPracticas.ods** (Guardar el documento en la carpeta de evidencias del periodo actual).
...
14. ABRA el archivo **G1111-calificaciones.xls** con el software **LibreOffice Calc**.
...
17. VERIFIQUE que ahora tiene 3 archivos en su carpeta de evidencias así:
    ...
    - **G1111A07-calificaciones.xls**
    - **G1111A07-calificaciones.ods**
    - **G1111A07-calificaciones.csv**
...
---
## A08: Cortar, copiar y pegar {kbd}`202` (5%)
{bdg-warning}`Actividad práctica`
...
3. ABRA el archivo **G1111A08-calculo-precios.ods**
...
7. GUARDE los cambios y CIERRE el documento **G1111A08-calculo-precios.ods**

8. ABRA el archivo **G1111A08-antiguedad-saldos.ods**
...
---
## A09: formatos ($, #, 20/08/2020, 0.0) {kbd}`102` (5%)
{bdg-warning}`Actividad práctica`
...
2. Abra el archivo G1111A09-animales-raza.ods y seleccione toda la fila 1 (PULSAR clic izquierdo sobre el número 1 de la fila), luego genere el menú contextual sobre la fila 1 (PULSAR clic derecho sobre el número 1 de la fila). Luego del menú contextual, SELECCIONAR la opción **Formato de celdas**.
...
---
## A10: Buscar, reemplazar, ocultar y rellenar {kbd}`307` (5%)
{bdg-warning}`Actividad práctica`
...
2. ABRA el archivo **G1111A10-frutas.ods** y PULSE las teclas: {kbd}`CTRL` + {kbd}`B` para abrir el menú de búsqueda en la parte inferior de la interfaz.
...
6. Guarde los cambios y abra el documento: **G1111A10-ventas-ferreteria.ods**.
...
9. Guarde los cambios y cree un nuevo documento de nombre: **G1111A10-control-gastos-semanales.ods**
...
13. En la celda B9, escriba el número: **1**. Luego atrastre el cuadrado pequeño hasta la celda H9.

14. En la celda H10, escriba: **60km**. Luego atrastre el cuadrado pequeño hasta la celda B10.

15. En la celda B11, escriba el mes: **enero.** Luego atrastre el cuadrado pequeño hasta la celda H11.
...
---
## A11: Presentación de evidencias (40%)
{bdg-danger}`Transferencia`
