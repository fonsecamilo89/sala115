...
:::{admonition} Definición de HARDWARE
...
:::{admonition} Definición de CPU

```{list-table}
* - ```{figure} ./recursos/G821/image01.png
    :width: 300
    CPU 
    ```
```
...
:::{admonition} Definición de Memoria RAM

```{list-table}
* - ```{figure} ./recursos/G821/image02.png
    :width: 300
    Memoria RAM 
    ```
```
...
```{list-table}
* - ```{figure} ./recursos/G821/image03.png
    :width: 300
...
:::{admonition} Definición de Sistema Computacional
...
```{list-table}
* - ```{figure} ./recursos/G821/image04.png
    :width: 300
    Computadora 
    ```
```
...
:::{admonition} Definición de Informática
...
:::{admonition} Definición de Razonar
...
:::{admonition} Definición de Lógica
...
:::{admonition} Definición de **LÓGICA COMPUTACIONAL**
...
4. En su cuaderno cree un **mapa conceptual** de los tres principales componentes de la CPU y descríbalos.

5. En INTERNET, consulte 3 marcas de fabricantes de CPU y descríbalas en su cuaderno.
...
7. En Internet, consulte las diferentes generaciones de memoria RAM y con esta información en su cuaderno CREE un mapa conceptual.

8. Con los temas vistos hasta ahora, en **UNA PÁGINA DE CUADERNO**, con sus palabras (no usar IA) responda la siguiente pregunta:
...
2. En su cuaderno, con sus palabras escriba 5 ejemplos de sistemas computacionales (no usar IA). Tenga en cuenta el siguiente ejemplo:
...
:::{list-table}
* - ```{figure} ./recursos/G821/image05.png
    :align: center
    :width: 300
...
**TIEMPO** ; 29 minutos
**PREGUNTAS** ; 10
**OBJETIVO** ; Comprobar conocimientos adquiridos de los conceptos de lógica computacional.
